...
- (void)createViewControllers
{
    ...
    naviHome.tabBarItem = [[UITabBarItem alloc] initWithTitle:@"首页" image:[self configureImage:@"params1"] selectedImage:[self configureImage:@"params"]];
    ...
    naviorder.tabBarItem = [[UITabBarItem alloc] initWithTitle:@"订单" image:[self configureImage:@"news"] selectedImage:[self configureImage:@"news1"]];
    ...
    naviUsercenter.tabBarItem = [[UITabBarItem alloc] initWithTitle:@"我的" image:[self configureImage:@"study"] selectedImage:[self configureImage:@"study1"]];
